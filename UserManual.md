...
The latest version of PLPTool (5.0) is available on [GitHub](https://github.com/jabocg/progressive-learning-platform/tree/master). Download the .zip file on the right side.  It will contain the following directories:
